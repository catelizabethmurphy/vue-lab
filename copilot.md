...
1. how single-file components work
2. what <script setup>, <template> and <style scoped> do
3. what ref and reactivity do
4. how to use v-if and v-for to control rendering
5. how props work
